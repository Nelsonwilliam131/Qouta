/* ============================================================
   QOUTA — app.js
   Curated quotes bank — hand-picked quotes
   Seen-stack per browser via localStorage
   Wikipedia: search character name directly, fallback to gold initial
   ============================================================ */
...
const STORAGE_SEEN = "qouta_seen_v4";
const STORAGE_HIST = "qouta_history_v4";
...
const CURATED = [
  ...
  { content: "Only I can call my dream stupid!", author: "Monkey D. Luffy" },
  {
    content:
  ...
  // ANIME — DEMON SLAYER
  { content: "Set your heart ablaze!", author: "Kyojuro Rengoku" },
  {
    content:
  ...
  // ANIME — DEATH NOTE
  { content: "I am justice!", author: "Light Yagami" },
  {
    content:
  ...
  { content: "You can become a hero.", author: "All Might" },
  ...
  {
    content: "At this stage of your life, focus on building your capability.",
    author: "GehGeh",
  },
  {
    content: "Stop playing with your time, make good use of your time well.",
    author: "GehGeh",
  },
  {
    content:
      "How you see me nor really concern me, na how I see myself na important for life.",
    author: "GehGeh",
  },
  {
    content:
      "How long you live nor really matter, na how well you take leave am na matter.",
    author: "GehGeh",
  },
  // GAME CHARACTERS
  {
...
/* ── WIKIPEDIA IMAGE — search by name directly ────────────── */
...
/* ── INIT ─────────────────────────────────────────────────── */
(async function init() {
  // Always build pool fresh from CURATED on every page load
  // so quote changes appear immediately without any cache clearing
  buildPool();
  // Load only seen stack and history from localStorage
  loadState();
  // Filter seen indices that are out of range after pool rebuild
  seen = seen.filter((i) => i < pool.length);
  await showNext();
  startAutoTimer();
})();
